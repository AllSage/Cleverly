"""scripts/_lib/cli.py — shared scaffolding for the `cleverly-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("cleverly-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/cleverly-foo`
...
VERSION = "0.1.0"  # bumped centrally; every cleverly-* CLI reports this
