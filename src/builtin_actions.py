...
async def action_check_email_urgency(owner: str, **kwargs) -> Tuple[str, bool]:
    ...
    try:
                    ...
                    for uid_b in uids:
                        ...
                        try:
                            ...
                            if not raw:
                                continue
                            msg = _email_mod.message_from_bytes(raw)
                            # Skip Cleverly-generated reminders so the scanner
                            ...
                            _mail_origin = (msg.get("X-Cleverly-Origin") or "").strip().lower()
                            _mail_kind = (msg.get("X-Cleverly-Kind") or "").strip().lower()
                            ...
                            if (_mail_origin == "cleverly-ui" or _mail_kind == "reminder"
                                    or _raw_subj.startswith("reminder (cleverly):")
        ...
        if new_urgent:
            ...
            # straight into the Cleverly Email tab).
...
BUILTIN_ACTION_INFO = {
    ...
    "run_script": "Run a script locally or on CLEVERLY_SCRIPT_HOST",
