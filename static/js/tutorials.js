...
function ensureStyles() {
  ...
  style.textContent = `
    .tutorials-body{height:calc(100% - 46px);padding:12px;box-sizing:border-box;overflow:hidden;}
    .tutorials-shell{height:100%;min-height:0;display:grid;grid-template-columns:minmax(230px,300px) minmax(0,1fr);gap:10px;}
    .tutorials-nav{border:1px solid var(--border);border-radius:8px;background:color-mix(in srgb,var(--panel) 70%,transparent);padding:8px;overflow:auto;min-height:0;}
    .tutorials-card{width:100%;border:1px solid transparent;background:transparent;color:var(--fg);border-radius:7px;padding:9px;text-align:left;cursor:pointer;margin-bottom:6px;display:grid;gap:4px;}
    ...
    .tutorials-card-kicker{font-size:10px;text-transform:uppercase;letter-spacing:.04em;color:#67e8f9;font-weight:750;}
    .tutorials-card-title{font-size:13px;font-weight:800;line-height:1.2;}
    .tutorials-card-summary{font-size:11px;line-height:1.35;opacity:.72;}
    ...
    .tutorials-hero{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(240px,.85fr);gap:14px;align-items:start;}
    .tutorials-copy{min-width:0;}
    .tutorials-kicker{font-size:11px;color:#67e8f9;text-transform:uppercase;letter-spacing:.04em;font-weight:800;margin-bottom:6px;}
    ...
    .tutorials-image-wrap{min-width:0;}
    .tutorials-image-btn{display:block;width:100%;border:1px solid color-mix(in srgb,var(--border) 80%,transparent);background:#070b12;border-radius:8px;padding:0;overflow:hidden;cursor:zoom-in;}
    .tutorials-image-btn img{display:block;width:100%;height:auto;aspect-ratio:16/9;object-fit:cover;}
    ...
    .tutorials-btn{border:1px solid var(--border);border-radius:7px;background:var(--panel);color:var(--fg);font-size:12px;padding:8px 10px;cursor:pointer;display:inline-flex;align-items:center;gap:7px;}
    ...
    @media(max-width:860px){.tutorials-body{overflow:auto}.tutorials-shell{height:auto;grid-template-columns:1fr}.tutorials-nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;overflow:visible}.tutorials-card{margin-bottom:0}.tutorials-hero{grid-template-columns:1fr}.tutorials-panel{overflow:visible}}
